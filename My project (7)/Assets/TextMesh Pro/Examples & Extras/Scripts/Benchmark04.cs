        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    //textLable.fontSharedMaterial = material;
                    //textLable.font = Resources.Load("Fonts & Materials/LiberationSans SDF", typeof(TextMeshProFont)) as TextMeshProFont;
                    //textLable.anchor = AnchorPositions.Left;
